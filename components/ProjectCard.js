...
const ProjectCard = ({
  ...
  return (
    ...
    >
      <div
        className={`flex items-center justify-center w-full p-8 overflow-hidden h-80 ${theme} relative overflow-hidden`}
      >
        ...
        {images.length < 1 && (
          <div className="absolute bottom-0 w-9/12 overflow-hidden bg-white rounded-tl-lg rounded-tr-lg h-5/6">
            ...
            <div className="flex flex-col items-start w-full px-10 pt-6 space-y-4 ">
      ...
      <div className="flex flex-col items-start w-full p-4 border-t border-gray-200">
        ...
        <span className="mt-4 text-sm font-light text-gray-900 font-inter ">
          {title}
        </span>
